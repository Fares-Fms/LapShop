...
var ClsItems = {
    GetAll: function () {
        Helper.AjaxCallGet("https://localhost:7201/api/item/GetAll/2", {}, "json",
            function (data) {
                        var htmlData = "";
    ...
    DrawItem: function (item) {
        ...
        data += "<div class='front'> <a href='/Show_Items/main/" + item.ItemId + "'><img src='/Uploads/items/" + item.imageName + "' class='img-fluid blur-up lazyload bg-img' alt=''></a></div>";
        data += "<div class='back'> <a href='/Show_Items/main/" + item.ItemId + "'><img src='/Uploads/items/" + item.imageName + "' class='img-fluid blur-up lazyload bg-img' alt=''></a></div>";
