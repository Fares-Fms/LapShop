...
public partial class LapShopContext : IdentityDbContext<ApplicationUser>
{
    ...
    public virtual DbSet<TbMessages> Messages { get; set; }
    public virtual DbSet<TbBusinessInfo> TbBusinessInfos { get; set; }
   
    public virtual DbSet<TbSettings> TbHomeSettings { get; set; }
    ...
    public virtual DbSet<UserModel> TbUserModel { get; set; }
