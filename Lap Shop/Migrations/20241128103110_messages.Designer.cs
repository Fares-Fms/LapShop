...
namespace Lap_Shop.Migrations
{
    ...
    [Migration("20241128103110_messages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lap_Shop.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbMessages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbSettings", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("HomeSlide")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SecoundSlide")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("TbHomeSettings");
                });

            modelBuilder.Entity("Lap_Shop.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.UserModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("TbUserModel");
                });

            modelBuilder.Entity("Lap_Shop.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lap_Shop.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("Lap_Shop.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("Lap_Shop.Models.TbBusinessInfo", "CutomerId")
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItem", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("Lap_Shop.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("Lap_Shop.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbItemDiscount", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("Lap_Shop.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Lap_Shop.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("Lap_Shop.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lap_Shop.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
